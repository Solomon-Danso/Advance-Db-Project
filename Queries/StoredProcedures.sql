DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_District`( IN p_district_code varchar(20))
Begin 
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_agricultural_activity`(IN p_agriculture_id INT)
BEGIN
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_disability`(IN p_disability_id INT)
BEGIN
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_economic_activity`(IN p_activity_id INT)
BEGIN
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_education`(IN p_education_id INT)
BEGIN
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_enumerationarea`(IN `p_ea_code` VARCHAR(20))
Begin 
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_fertility`(IN p_fertility_id INT)
BEGIN
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_household`( IN p_household_id int)
Begin 
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_housing_condition`(IN p_housing_id INT)
BEGIN
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_locality`(
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_person`(IN p_person_id INT)
BEGIN
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_region`(IN `p_region_code` VARCHAR(20))
BEGIN
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_subdistrict`(
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_agricultural_activities_by_household`(IN p_household_id INT)
BEGIN
    SELECT 
        aa.*,
        h.ea_code,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_agricultural_activity`(IN p_agriculture_id INT)
BEGIN
    SELECT 
        aa.*,
        h.ea_code,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_all_agricultural_activities`()
BEGIN
    SELECT 
        aa.*,
        h.ea_code,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_all_disabilities`()
BEGIN
    SELECT 
        d.*,
        p.full_name,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_all_district`()
Begin 
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_all_economic_activities`()
BEGIN
    SELECT 
        ea.*,
        p.full_name,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_all_educations`()
BEGIN
    SELECT 
        e.*,
        p.full_name,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_all_fertilities`()
BEGIN
    SELECT 
        f.*,
        p.full_name,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_all_households`()
Begin 
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_all_housing_conditions`()
BEGIN
    SELECT 
        hc.*,
        h.ea_code,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_all_localities`()
Begin 
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_all_persons`()
BEGIN
    SELECT 
        p.*,
        h.ea_code,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_disabilities_by_person`(IN p_person_id INT)
BEGIN
    SELECT 
        d.*,
        p.full_name,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_disability`(IN p_disability_id INT)
BEGIN
    SELECT 
        d.*,
        p.full_name,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_economic_activities_by_person`(IN p_person_id INT)
BEGIN
    SELECT 
        ea.*,
        p.full_name,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_economic_activity`(IN p_activity_id INT)
BEGIN
    SELECT 
        ea.*,
        p.full_name,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_education`(IN p_education_id INT)
BEGIN
    SELECT 
        e.*,
        p.full_name,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_educations_by_person`(IN p_person_id INT)
BEGIN
    SELECT 
        e.*,
        p.full_name,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_enumerationarea`()
Begin 
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_fertilities_by_person`(IN p_person_id INT)
BEGIN
    SELECT 
        f.*,
        p.full_name,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_fertility`(IN p_fertility_id INT)
BEGIN
    SELECT 
        f.*,
        p.full_name,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_household_members`(IN p_household_id INT)
BEGIN
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_household_with_members`(
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_housing_condition`(IN p_housing_id INT)
BEGIN
    SELECT 
        hc.*,
        h.ea_code,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_housing_conditions_by_household`(IN p_household_id INT)
BEGIN
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_person`(IN p_person_id INT)
BEGIN
    SELECT 
        p.*,
        h.ea_code,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_persons_by_household`(IN p_household_id INT)
BEGIN
    SELECT * FROM Person 
    WHERE household_id = p_household_id
    ORDER BY 
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_subdistricts`()
Begin 
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_agricultural_activity`(
    IN p_household_id INT,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_disability`(
    IN p_person_id INT,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_district`(
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_economic_activity`(
    IN p_person_id INT,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_enumerationarea`(IN `p_ea_code` VARCHAR(20), IN `p_locality_code` VARCHAR(20), IN `p_ea_type` VARCHAR(20), IN `p_ea_number` VARCHAR(20))
Begin 
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_fertility`(
    IN p_person_id INT,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_household`(
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_housing_condition`(
    IN p_household_id INT,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_locality`(
IN p_locality_code varchar(20),
IN p_sub_district_code varchar(20),
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_person`(
    IN p_household_id INT,
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_subdistrict`(
IN p_sub_district_code varchar(20),
IN p_district_code varchar(20),
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_education`(
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_person`(
    IN p_person_id INT,
    IN p_household_id INT,
    IN p_full_name VARCHAR(100),
    IN p_relationship_to_head ENUM('Head', 'Spouse', 'Child', 'Parent/Parent in-law', 'Son/Daughter in-law', 'Grandchild', 'Brother/Sister', 'Step child', 'Foster child', 'Other relative', 'Non-relative'),
